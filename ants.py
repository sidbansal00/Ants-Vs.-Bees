...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        if self.place.ant and self.place.ant.blocks_path == False:
            return False
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        if self.was_scared and self.count_scared <= 2:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place.entrance != hive and not place.bees and counter < self.max_range:
            place = place.entrance
            counter += 1
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            ...
            select = random_or_none(self.place.bees)
            Insect.reduce_armor(select,select.armor)
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 7
        for a in list(self.place.bees):
            Insect.reduce_armor(a,self.damage)
        # END Problem 7
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_impostor:
            ...
            while behind:
                if behind.ant:
                    if behind.ant.is_container and behind.ant.contained_ant and behind.ant.contained_ant not in self.doubled_ants:
                        behind.ant.contained_ant.damage *= 2
                        self.doubled_ants.append(behind.ant.contained_ant)
